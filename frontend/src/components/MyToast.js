 ...
 *
 * @component
 * @param {Object} props - The properties of the toast.
 * @param {boolean} props.open - Indicates whether the toast is open or closed.
 * @param {function} props.setOpen - A function to handle the open state of the toast.
 * @returns {JSX.Element} The rendered toast component.
 */
const MyToast = ({ open, setOpen, title, description }) => {
  return (
    <Toast.Provider swipeDirection="right">
      ...
      >
        ...
        <Toast.Description asChild>
          <p className="grid-area-description m-0 text-slate11 text-13 leading-1.3">
            {description}
          </p>
        </Toast.Description>
        <Toast.Action
